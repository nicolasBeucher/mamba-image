...
Width w and height h are the two other parameters (attributes) of an image. \txtit{width} is the number of
...
\begin{figure}
\centering
\includegraphics[scale=0.3]{images/xxx.png}
